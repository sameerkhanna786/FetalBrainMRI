...
| Full test gate is required before each commit                 | `npx pnpm@10.4.1 test -- --runInBand`                                       | Validation data conditional guard increment reran the full Vitest suite with 248 passing tests.                                                                                                                 | Passed               |
