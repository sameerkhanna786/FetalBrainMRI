...
| Full test gate is required before each commit                 | `npx pnpm@10.4.1 test -- --runInBand`                                       | Validation data schema guard increment reran the full Vitest suite with 247 passing tests.                                                                                                                      | Passed               |
