...
| Source-data final lock         | Supplement / appendix             | Dovjak table check, Woitek table check, extra-axial CSF coefficient decision, third-ventricle raw-threshold policy, and Chiari calibration status.               | Clinician collaborator | Go only after unresolved source checks are marked reviewed |
